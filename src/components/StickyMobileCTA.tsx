...
const StickyMobileCTA = () => {
    ...
    return (
        ...
        >
            <div className="bg-black/95 backdrop-blur-xl border border-accent/20 rounded-[16px] p-2">
                <div className="grid grid-cols-3 gap-2">
                    <Button
                        onClick={handleCall}
                        variant="ghost"
                        className="flex flex-col gap-0.5 h-auto py-2 text-accent/70 hover:text-accent hover:bg-accent/10 rounded-[8px] border border-transparent hover:border-accent/30 transition-all"
                    >
                    ...
                    <Button
                        ...
                        className="flex flex-col gap-0.5 h-auto py-2 bg-accent hover:bg-white text-black rounded-[8px] transition-all duration-300 border border-accent"
                    >
