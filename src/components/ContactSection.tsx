...
const ContactSection = () => {
  ...
  return (
    <section id="contatti" className="py-24 text-accent border-t border-accent/20 relative overflow-hidden" style={{ backgroundImage: `url('/images/sfondo-kit-contatti.jpg')`, backgroundSize: 'cover', backgroundAttachment: 'fixed', backgroundPosition: 'center' }}>
        ...
        <div className="grid lg:grid-cols-2 gap-16 md:gap-24">
          ...
          <div>
            ...
            <div className="mb-24">
                ...
                <div className="mt-12 space-y-12">
                  ...
                  <div className="flex flex-col gap-8">
                    <div className="border-l border-accent/20 pl-6 space-y-4">
                      <h4 className="font-bold uppercase tracking-widest text-base text-accent">📝 Iscrizioni & Scadenza</h4>
                      ...
                      <div className="p-4 border border-accent/20 bg-accent/5 text-xs font-mono text-accent/80 uppercase max-w-lg">
                          Pagamento in un’unica soluzione o in due rate (acconto e saldo).
                      </div>
                    </div>
                    {/* Media centered and smaller as per fallback request */}
                    <div className="w-full max-w-[280px] border border-accent/20 bg-accent/5 p-2 animate-in fade-in zoom-in-95 duration-700">
                      <video 
            ...
            <div className="mb-24 pt-12 border-t border-amber-500/10">
                <div className="inline-block px-4 py-2 bg-amber-500/20 border border-amber-500/40 text-amber-500 text-sm font-bold uppercase tracking-widest mb-8 font-mono">
                    Forlì ☀️
                </div>
                ...
                <div className="mt-12 space-y-12">
                  <div className="border-l border-amber-500/30 pl-6">
                    <h4 className="font-bold uppercase tracking-widest mb-4 text-base text-amber-500">🎯 Il Percorso Tecnico</h4>
                    ...
                    <p className="mt-6 text-sm italic text-amber-500 font-mono">
                        Oltre al campo, spazio al divertimento: musica, giochi e gli immancabili gavettoni assicurati! 💦
                    </p>
                  </div>

                  <div className="border-l border-amber-500/30 pl-6">
                    <h4 className="font-bold uppercase tracking-widest mb-4 text-base text-amber-500">📦 La Formula: Allenamento & Pranzo</h4>
                    <p className="text-sm font-bold text-white mb-4">Una soluzione completa per vivere il camp con la massima energy (Orario: 8:30 – 15:00):</p>
                    <ul className="space-y-3 text-sm font-mono text-zinc-400 uppercase tracking-wide">
                  ...
                  <div className="flex flex-col gap-8">
                    <div className="border-l border-amber-500/20 pl-6 space-y-4">
                      <h4 className="font-bold uppercase tracking-widest text-base text-amber-500">📝 Iscrizioni & Scadenza</h4>
                      <p className="text-sm text-zinc-400 font-mono uppercase">
                          Aperte fino al <span className="text-white">10 Maggio</span>. Posti limitati.
                      </p>
                      <div className="p-4 border border-amber-500/20 bg-amber-500/5 text-xs font-mono text-amber-200/80 uppercase max-w-lg">
                          Pagamento in un’unica soluzione o in due rate (acconto e saldo).
                      </div>
                    </div>
                    {/* Media centered and smaller as per fallback request */}
                    <div className="w-full max-w-[280px] border border-amber-500/20 bg-amber-500/5 p-2 animate-in fade-in zoom-in-95 duration-1000 delay-150">
            ...
            <div className="border-l border-zinc-800 pl-6 pt-6 grayscale opacity-80 hover:grayscale-0 hover:opacity-100 transition-all">
