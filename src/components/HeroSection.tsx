    ...
    return (
      ...
      <div className="relative z-10 container mx-auto px-6 md:px-12 pt-28 md:pt-20">
        <div className="max-w-4xl">
          ...
          <h1 
            className="text-[clamp(3.5rem,15vw,9rem)] font-bold text-accent tracking-tighter leading-[0.85] mb-8 drop-shadow-[0_4px_12px_rgba(0,0,0,0.6)] font-display" 
          >
            <span className="block fade-up will-animate" data-delay="0.5">GIOVANI</span>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-[#4ade80] block fade-up will-animate" data-delay="0.7">
              CAMPIONI.
            </span>
          </h1>
